...
export function InfoFaqSection() {
  ...
  return (
    <section id="faq" className="section-padding relative scroll-mt-[156px] bg-[#f5f5f3]">
      <div className="container-wide">
        ...
        <div className="mb-8 flex flex-wrap gap-2">
          <button
            ...
            className={cn(
              "no-outline rounded-full border px-5 py-2.5 text-[12px] font-semibold uppercase tracking-[0.12em]",
              INFO_PILL_TRANSITION,
              tab === "houses"
                ? "border-[#77d14d] bg-[#77d14d] text-[#3a3a38] shadow-[0_6px_20px_rgba(119,209,77,0.3)]"
                : "border-[#e0e0dc] bg-white text-[#555552] hover:border-[#77d14d]/50",
            )}
          >
            {p.faqTabHouses}
          </button>
            ...
            {list.map((faq, i) => (
              ...
              >
                <button
                  ...
                  className="group flex w-full items-center justify-between gap-4 py-5 text-left transition-colors duration-500 ease-[0.22,1,0.36,1]"
                >
                  <span className="text-[15px] font-semibold text-[#131311] transition-colors duration-500 ease-[0.22,1,0.36,1] group-hover:text-[#77d14d]">
                    {locale === "en" ? faq.questionEn ?? faq.question : faq.question}
                  </span>
                  <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-[#e8e8e5] text-[#77d14d] transition-[border-color,background-color] duration-500 ease-[0.22,1,0.36,1] group-hover:border-[#77d14d]/40">
