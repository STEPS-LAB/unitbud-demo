    ...
    <>
      ...
      <div className="lg:hidden sticky-bar fixed bottom-0 inset-x-0 z-40 bg-white border-t border-[#e8e8e5] px-4 py-3 flex gap-3">
        <a
          ...
          className="flex items-center justify-center gap-2 flex-1 border border-[#e8e8e5] rounded-[4px] py-3 text-sm font-500 text-[#3a3a38] hover:border-[#728c4a] transition-colors"
        >
          <Phone size={14} className="text-[#728c4a]" />
          Зателефонувати
        </a>
        <button
