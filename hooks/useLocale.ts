...
const translations = {
  uk: {
    ...
    footerText: {
      ...
      address:
        "м. Житомир, вул. Героїв Чорнобиля, 6а (відвідування за попередньою домовленістю)",
      workingHours: "пн-пт з 9:00 до 18:00",
      phoneDisplay: "+38 (067) 106 75 06",
      emailDisplay: "office@unitbud.com",
      navigation: "Навігація",
      contactsTitle: "Контакти",
      navHome: "Головна",
      navModels: "Модельний ряд",
      navBusiness: "Проєкти для бізнесу",
      navBaths: "Лазні",
      navInstalled: "Реалізовані проєкти",
      navAbout: "Про нас",
      navInfo: "Інфоцентр",
      navUseful: "Корисно знати",
      navCatalog: "Каталог",
      navGallery: "Реалізовані проєкти",
      emailLead: "Email:",
      phoneLead: "Телефон:",
      catalog: "Каталог",
      company: "Компанія",
  ...
  en: {
    ...
    footerText: {
      ...
      address:
        "Zhytomyr, Heroes of Chornobyl St, 6a (visits by prior arrangement only)",
      ...
      navHome: "Home",
      navModels: "Model range",
      navBusiness: "Business projects",
      navBaths: "Bathhouses",
      navInstalled: "Completed projects",
      navAbout: "About us",
      navInfo: "Info center",
      navUseful: "Good to know",
      navCatalog: "Catalog",
      navGallery: "Completed projects",
      emailLead: "Email:",
      phoneLead: "Phone:",
      catalog: "Catalog",
      company: "Company",
