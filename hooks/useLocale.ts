...
const translations = {
  uk: {
    ...
    infoPage: {
      ...
      navInstallation: "Монтаж",
      navAdvantages: "Переваги",
      navModular: "Про модульні",
      navFast: "Швидкобуд",
      navSaunas: "Лазні",
      navFaq: "Питання",
      faqTabHouses: "Будинки",
      faqTabSaunas: "Лазні",
      faqSub: "Відповіді на найпоширеніші запитання щодо модульних будинків та бань",
      faqCtaLead:
  ...
  en: {
    ...
    infoPage: {
      ...
      faqTabHouses: "Houses",
      faqTabSaunas: "Saunas",
      faqSub: "Answers to common questions about modular homes and baths",
      faqCtaLead:
