...
const translations = {
  uk: {
    ...
    sections: {
      ...
      viewingBooking: "Запишіться на перегляд будинку",
      viewingBookingSub: "Залиште контакти — узгодимо зручний час візиту на об'єкт або в офіс.",
      ...
      calcPremium: "Преміум",
      calcLux: "Люкс",
      calcFromCalculatorNote:
        "Дані взяті з калькулятора розрахунку орієнтовної вартості.",
    },
    form: {
      name: "Ваше ім'я",
      ...
      submitViewing: "Записатися на перегляд",
    ...
    catalogPage: {
      ...
      catPremium: "Преміум",
      catElite: "Еліт",
      residentialModelsTitle: "Житлові моделі",
      residentialModelsExpand: "Показати лінії житлових моделей",
      residentialModelsCollapse: "Сховати лінії житлових моделей",
      residentialFilterMb102: "Модульні будинки в стилі хай-тек",
      residentialFilterMb92: "Скандинавські модульні будинки",
      residentialFilterHouse92: "Дачні модульні будинки",
    },
    housePage: {
      home: "Головна",
      catalog: "Каталог",
    ...
    infoPage: {
      ...
      navPayment: "Оплата",
      navDeliveryInstall: "Доставка та монтаж",
      navAdvantages: "Переваги",
      navModular: "Про будинки",
      navFast: "Швидкобуд",
      navSaunas: "Лазні",
      navFaq: "Питання",
      faqTabHouses: "Будинки",
      faqTabSaunas: "Лазні",
      faqCtaLead:
        "Не знайшли відповідь? Зателефонуйте або залиште заявку — підкажемо по вашій ситуації.",
    },
    contactsPage: {
      breadcrumbHome: "Головна",
      breadcrumbCurrent: "Контакти",
      intro:
        "Телефон, пошта та соцмережі — оберіть зручний спосіб зв’язку, відповімо якнайшвидше.",
      phoneLabel: "Телефон",
      emailLabel: "Пошта",
      socialNetworksTitle: "Соціальні мережі",
      officeLabel: "Наш офіс",
      officeLine1: "Україна, м. Житомир,",
      officeLine2: "вул. Героїв Чорнобиля, 6а",
      officeNote: "(відвідування за попередньою домовленістю)",
      mapIframeTitle: "Карта: офіс Unitbud у Житомирі",
      mapOpenExternal: "Відкрити в Google Картах",
  ...
  en: {
    ...
    sections: {
      ...
      viewingBooking: "Book a house viewing",
      viewingBookingSub: "Share your details — we’ll schedule a visit to the site or our office.",
      ...
      calcPremium: "Premium",
      calcLux: "Lux",
      calcFromCalculatorNote: "Figures from the estimated cost calculator.",
    },
    form: {
      name: "Your name",
      phone: "Phone number",
      ...
      submitViewing: "Request a viewing",
    ...
    catalogPage: {
      ...
      catPremium: "Premium",
      catElite: "Elite",
      residentialModelsTitle: "Residential models",
      residentialModelsExpand: "Show residential model lines",
      residentialModelsCollapse: "Hide residential model lines",
      residentialFilterMb102: "High-tech modular houses",
      residentialFilterMb92: "Scandinavian modular houses",
      residentialFilterHouse92: "Summer cottage modular houses",
    },
    housePage: {
      home: "Home",
      catalog: "Catalog",
    ...
    infoPage: {
      ...
      navPayment: "Payment",
      navDeliveryInstall: "Delivery & installation",
      navAdvantages: "Benefits",
      navModular: "About houses",
      navFast: "Prefab",
      navSaunas: "Saunas",
      navFaq: "FAQ",
      faqTabHouses: "Houses",
      faqTabSaunas: "Saunas",
      faqCtaLead:
        "Didn’t find an answer? Call us or leave a request — we’ll advise for your case.",
    },
    contactsPage: {
      breadcrumbHome: "Home",
      breadcrumbCurrent: "Contacts",
      intro: "Phone, email, and social media — choose how to reach us and we’ll reply as soon as we can.",
      phoneLabel: "Phone",
      emailLabel: "Email",
      socialNetworksTitle: "Social networks",
      officeLabel: "Our office",
      officeLine1: "Ukraine, Zhytomyr,",
      officeLine2: "6a Heroiv Chornobylia St.",
      officeNote: "(visits by prior arrangement)",
      mapIframeTitle: "Map: Unitbud office in Zhytomyr",
